...
public class ExtFormatSupport extends FormatSupport {
	 ...
	 */
	public FormatTokenPosition findImportant(FormatTokenPosition startPosition, FormatTokenPosition limitPosition,
	 ...
	 */
	public TokenItem findToken(TokenItem startToken, TokenItem limitToken, TokenID tokenID,
			TokenContextPath tokenContextPath, String tokenImage, boolean backward) {
	 ...
	 *            forward direction.
	 */
	public TokenItem findMatchingToken(TokenItem startToken, TokenItem limitToken, TokenID matchTokenID,
			String matchTokenImage, boolean backward) {
	...
	public TokenItem findMatchingToken(TokenItem startToken, TokenItem limitToken, ImageTokenID matchTokenID,
			boolean backward) {
	 ...
	 * array that matched can be found by calling <tt>getIndex()</tt> method. It
	 * is suitable mainly for the image-token-ids.
	 * 
	 * @param startToken
	 ...
	 *            forward direction.
	 */
	public TokenItem findAnyToken(TokenItem startToken, TokenItem limitToken, TokenID[] tokenIDArray,
			TokenContextPath tokenContextPath, boolean backward) {
