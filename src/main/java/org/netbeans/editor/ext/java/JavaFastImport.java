...
public class JavaFastImport implements ActionListener {
	...
	private JButton[] getButtons() {
		if (buttons == null) {
			...
			buttons[0].getAccessibleContext()
					.setAccessibleDescription(LocaleSupport.getString("ACSD_JFI_importButton")); // NOI18N
			buttons[1].getAccessibleContext()
					.setAccessibleDescription(LocaleSupport.getString("ACSD_JFI_cancelButton")); // NOI18N
		}
