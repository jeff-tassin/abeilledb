...
public class ExtSettingsDefaults extends SettingsDefaults {
	...
	public static final Coloring defaultHighlightCaretRowColoring = new Coloring(null, null,
			defaultHighlightCaretRowBackColor);
	...
	public static final Coloring defaultHighlightMatchBraceColoring = new Coloring(null,
			defaultHighlightMatchBraceForeColor, defaultHighlightMatchBraceBackColor);
	...
	public static final MultiKeyBinding[] defaultExtKeyBindings = new MultiKeyBinding[] {
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_G, InputEvent.ALT_MASK),
			...
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_B, InputEvent.CTRL_MASK | InputEvent.SHIFT_MASK),
