	...
	public static abstract class LineFwdFinder extends FinderFactory.AbstractFinder {
		...
		public int find(int bufferStartPos, char buffer[], int offset1, int offset2, int reqPos, int limitPos) {
			...
			while (true) {
				...
				int lineOffset = lineFound(buffer, offset, lfOffset, Math.max(origStartPos - bufferStartPos, offset),
		 ...
		 */
		protected abstract int lineFound(char[] buffer, int lineStartOffset, int lineEndOffset, int startOffset,
				int endOffset);
