...
public interface DTD {
	 ...
	 * @return List of all Elements from this DTD starting with
	 *         <CODE>prefix</CODE>, or empty List if no such Element found.
	 ...
	 * 
	 * @param prefix
	 *            the requred prefix of CharRefs. For empty string or
	 *            <CODE>null</CODE>, List of all CharRefs from this DTD is
	 *            returned. The implementation <B>must</B> handle
	 *            <CODE>null</CODE> correctly.
	...
	public static interface Element {
		 ...
		 *            <CODE>null</CODE>, List of all Attributes of this Element
		 *            is returned. The implementation <B>must</B> handle
		 *            <CODE>null</CODE> correctly.
		 * @return List of all such Attributes, maybe empty, never
		 *         <CODE>null</CODE>.
		 */
	...
	public static interface Content {
		 ...
		 *         case the reduction lead to empty content, return
		 *         <CODE>EMPTY_CONTENT</CODE>. If the element doesn't reduce the
