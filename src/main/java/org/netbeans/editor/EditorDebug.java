...
public class EditorDebug {
	...
	public static void dumpPlanes(BaseDocument doc) {
		Class markClasses[] = new Class[] { MarkFactory.LineMark.class, MarkFactory.CaretMark.class,
				MarkFactory.DrawMark.class, MarkFactory.SyntaxMark.class, Mark.class };
	...
	public static void dumpSyntaxMarks(final BaseDocument doc) {
		 ...
		 * } if (delta < minMarkDistance) { minMarkDistance = delta; }
		 * lastMarkPos = pos;
		 * 
		 ...
		 * " getOffset()=" + Utilities.debugPosition(doc,
		 * syntaxMark.getOffset()) // NOI18N + ", getLine()=" +
		 * syntaxMark.getLine() // NOI18N + ", " + syntaxMark // NOI18N +
		 * ",\n    StateInfo=" + syntaxMark.getStateInfo() // NOI18N +
		 * ",\n    Syntax:" + syntax); // NOI18N } catch (InvalidMarkException
