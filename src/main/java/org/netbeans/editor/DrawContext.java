...
public interface DrawContext {
	 ...
	 * between <tt>getDrawStartOffset()</tt> and <tt>getDrawEndOffset</tt> will
	 * contain valid characters. However the first token can start even under
	 * <tt>getDrawStartOffset()</tt>. In this case the valid area starts at
	 * <tt>getTokenOffset()</tt> of the first token.
	 */
