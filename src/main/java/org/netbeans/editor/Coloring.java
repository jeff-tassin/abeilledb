...
public final class Coloring implements java.io.Serializable {
	...
	/** Construct new coloring */
	public Coloring(Font font, int fontMode, Color foreColor, Color backColor, Color underlineColor,
	...
	private Font modifyFont(Font f) {
		return new Font(((fontMode & FONT_MODE_APPLY_NAME) != 0) ? font.getName() : f.getName(),
	...
	public Coloring apply(Coloring c) {
		...
		if (c.fontMode != FONT_MODE_DEFAULT || newFont != c.font // currently
			...
			return new Coloring(newFont, FONT_MODE_DEFAULT, newForeColor, newBackColor, newUnderlineColor,
					newStrikeThroughColor);
		} else {
	...
	public boolean equals(Object o) {
		if (o instanceof Coloring) {
			...
			return ((font == null && c.font == null) || (font != null && font.equals(c.font)))
					&& (fontMode == c.fontMode)
					&& ((foreColor == null && c.foreColor == null) || (foreColor != null && foreColor
							.equals(c.foreColor)))
					&& ((backColor == null && c.backColor == null) || (backColor != null && backColor
							.equals(c.backColor)))
					&& ((underlineColor == null && c.underlineColor == null) || (underlineColor != null && underlineColor
							.equals(c.underlineColor)))
	...
	public static Coloring changeFont(Coloring c, Font newFont, int newFontMode) {
		if ((newFont == null && c.font == null)
				|| (newFont != null && newFont.equals(c.font) && c.fontMode == newFontMode)) {
			return c;
		}
