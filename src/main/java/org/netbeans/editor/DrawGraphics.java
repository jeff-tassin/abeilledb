...
interface DrawGraphics {
	 ...
	 *            shouldn't be done.
	 */
	public void drawTabs(int offset, int length, int spaceCount, int width, Color strikeThroughColor,
	...
	static final class GraphicsDG extends SimpleDG {
		...
		private void flush() {
			...
			if (AnnotationTypes.getTypes().isBackgroundDrawing().booleanValue()) {
				...
				if (alpha == null)
					alpha = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, AnnotationTypes.getTypes()
							.getBackgroundGlyphAlpha().intValue() / 100f);
			...
			if (strikeThroughColor != null) { // draw strike-through
				...
				graphics.fillRect(startX, startY + (int) (fmcInfo.getStrikethroughOffset(graphics) + 0.5), x - startX,
			...
			if (underlineColor != null) { // draw underline
				...
				graphics.fillRect(startX, startY + (int) (fmcInfo.getUnderlineOffset(graphics) + 1.5), x - startX,
		...
		public void drawChars(int offset, int length, int width, Color strikeThroughColor, Color underlineColor) {
			...
			if ((strikeThroughColor == null && this.strikeThroughColor != null)
					...
					|| (underlineColor == null && this.underlineColor != null)
					|| (underlineColor != null && !underlineColor.equals(this.underlineColor))) {
				flush();
			}
