...
public class SettingsNames {
	 ...
	 * <tt>TAB_SIZE</tt> and <tt>SPACES_PER_TAB</tt>. Values: java.lang.Integer
	 * instances
	 */
	 ...
	 * <tt>TOKEN_CONTEXT_LIST</tt> holds the list of token contexts that can be
	 * used by the given kit. The coloring names are without the suffix just
