...
public class MacroSavePanel extends javax.swing.JPanel {
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		removeButton.setToolTipText(LocaleSupport
				.getString("MSP_RemoveToolTip", "Remove a keybinding from this macro."));
	...
	class KeySequenceRequester {
		...
		KeySequenceRequester() {
			((JButton) buttons[0]).getAccessibleContext().setAccessibleDescription(
					LocaleSupport.getString("ACSD_MSP_ok")); // NOI18N
			((JButton) buttons[1]).getAccessibleContext().setAccessibleDescription(
					LocaleSupport.getString("ACSD_MSP_clear")); // NOI18N
			((JButton) buttons[2]).getAccessibleContext().setAccessibleDescription(
					LocaleSupport.getString("ACSD_MSP_cancel")); // NOI18N
		...
		String isAlreadyBounded(KeyStroke[] seq) {
			if (seq.length == 0)
				return null; // NOI18N not valid sequence, but don't alert user
