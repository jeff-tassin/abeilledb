...
/**
 * Shows the InstanceView preferences
 * 
 * @author Jeff Tassin
 */
public class InstancePreferencesView extends TSPanel {
	public static final String ID_CONFIRM_COMMIT = "instance.view.results.confirm.commit";
	 ...
	 * ctor
	 */
	public InstancePreferencesView(TSUserProperties userprops) {
	...
	private void loadData() {
		boolean show = Boolean.valueOf(m_userprops.getProperty(InstancePreferencesView.ID_CONFIRM_COMMIT, "true"))
				.booleanValue();
	 ...
	 */
	void save() {
		m_userprops.setProperty(InstancePreferencesView.ID_CONFIRM_COMMIT, String.valueOf(m_commitbox.isSelected()));
	}
}
