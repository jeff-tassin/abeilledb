...
public class AbstractResultSet  implements ResultSet {
    ...
    // 0-based index
    protected Map<Integer,RowInstance> m_rows = new HashMap<>();

    // map of pseudo-column names to column index
    protected Map<String, Integer> m_columnsByName = new HashMap<String, Integer>();

    // 1-based index
    protected Map<Integer,ColumnMetaData> m_columnsByIndex = new HashMap<>();

    protected ResultSetMetaData m_metadata = new TransposedMetaData();
