...
public class SerialNumber implements Comparable {
	...
	/** product code 'A' is for Abeille Pro 'B' is for Abeille Basic */
	 ...
	 * ctor
	 */
	public SerialNumber(int majVer, int minVer, int subMinVer, char lCode, int seqNumber, short stamp) {
		m_productcode = 'A';
	 ...
	 * ctor
	 */
	public SerialNumber(char lCode, int seqNumber, short stamp) {
		m_productcode = 'A';
		setLicenseCode(lCode);
		setSequenceNumber(seqNumber);
		setStamp(stamp);
	...
	/**
	 * @return true if this serial number is for a basic version of the code
	 */
	public boolean isBasic() {
		return (getProductCode() == 'B');
	}
