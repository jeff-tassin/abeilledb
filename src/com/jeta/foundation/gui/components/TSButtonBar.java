 ...
 * @author Jeff Tassin
 */
public class TSButtonBar extends TSPanel {
	...
	private void updateSettings() {
		...
		m_selected_color = new Color(Math.max((int) (c.getRed() * FACTOR), 0), Math.max((int) (c.getGreen() * FACTOR),
				0), Math.max((int) (c.getBlue() * FACTOR), 0));

		m_unselected_border = BorderFactory.createCompoundBorder(UIManager.getBorder("TableHeader.cellBorder"),
				BorderFactory.createEmptyBorder(2, 2, 2, 2));

		m_selected_border = BorderFactory.createCompoundBorder(
