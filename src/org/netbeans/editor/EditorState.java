 ...
 * indexed by state-holders' names. Typical usage is
 * <CODE>myState = EditorState.get( MY_STATE_NAME );</CODE> There is no support
 * for state change notifications, but the inserted value objects could be
 * singletons as well and could do its own notifications.
 * 
 * @author Petr Nejedly
 * @version 1.0
 */
