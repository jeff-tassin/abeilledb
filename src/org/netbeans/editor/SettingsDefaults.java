 ...
 * <tt>BaseSettingsInitializer</tt> to initialize the settings with the default
 * values. They can be also used for substitution if the value of the particular
...
public class SettingsDefaults {
	...
	public static final Coloring defaultLineNumberColoring = new Coloring(null, defaultLineNumberForeColor,
	...
	public static final Coloring defaultSelectionColoring = new Coloring(null, defaultSelectionForeColor,
			defaultSelectionBackColor);
	...
	public static final Coloring defaultHighlightSearchColoring = new Coloring(null, defaultHighlightSearchForeColor,
			defaultHighlightSearchBackColor);
	...
	public static final Coloring defaultIncSearchColoring = new Coloring(null, defaultIncSearchForeColor,
			defaultIncSearchBackColor);
	// Bookmark coloring
	...
	public static final Coloring defaultBookmarkColoring = new Coloring(null, defaultBookmarkForeColor,
			defaultBookmarkBackColor);
	...
	public static final Coloring defaultGuardedColoring = new Coloring(null, defaultGuardedForeColor,
			defaultGuardedBackColor);
	...
	public static final Coloring defaultStatusBarColoring = new Coloring(null, defaultStatusBarForeColor,
	...
	public static final String[] defaultColoringNames = new String[] { SettingsNames.DEFAULT_COLORING,
			SettingsNames.LINE_NUMBER_COLORING, SettingsNames.GUARDED_COLORING, SettingsNames.SELECTION_COLORING,
			SettingsNames.HIGHLIGHT_SEARCH_COLORING, SettingsNames.INC_SEARCH_COLORING,
	...
	public static final MultiKeyBinding[] defaultKeyBindings = new MultiKeyBinding[] {
			...
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, InputEvent.SHIFT_MASK | InputEvent.CTRL_MASK),
			...
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_HOME, InputEvent.SHIFT_MASK | InputEvent.CTRL_MASK),
			...
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_END, InputEvent.SHIFT_MASK | InputEvent.CTRL_MASK),
			...
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_C, InputEvent.CTRL_MASK | InputEvent.SHIFT_MASK),
			...
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_T, InputEvent.SHIFT_MASK | InputEvent.ALT_MASK),
					BaseKit.adjustCaretTopAction),
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_M, InputEvent.SHIFT_MASK | InputEvent.ALT_MASK),
			...
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_F, InputEvent.CTRL_MASK | InputEvent.SHIFT_MASK),
					BaseKit.formatAction),
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_J, InputEvent.ALT_MASK),
			...
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_K, InputEvent.SHIFT_MASK | InputEvent.ALT_MASK),
					BaseKit.jumpListPrevComponentAction),
			new MultiKeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_L, InputEvent.SHIFT_MASK | InputEvent.ALT_MASK),
			...
			new MultiKeyBinding(new KeyStroke[] { KeyStroke.getKeyStroke(KeyEvent.VK_J, InputEvent.CTRL_MASK),
					KeyStroke.getKeyStroke(KeyEvent.VK_S, 0), }, BaseKit.startMacroRecordingAction),

			new MultiKeyBinding(new KeyStroke[] { KeyStroke.getKeyStroke(KeyEvent.VK_J, InputEvent.CTRL_MASK),
					KeyStroke.getKeyStroke(KeyEvent.VK_E, 0), }, BaseKit.stopMacroRecordingAction), };
}
