...
public interface DrawLayer {
	 ...
	 * because <tt>isActive()</tt> will be called at the begining of the drawing
	 ...
	 * the line-number <tt>lineOffset + 1</tt> but some layers can change it. If
	 * the layer doesn't want to change the line-number it should return the
