 ...
 * public constructor. The only entrypoint is through the <tt>get()</tt> method.
 * It's guaranteed that the two context-paths containing the same contexts in
 * the same order are the same objects and the equal-operator can be used
 * instead of calling <tt>equals()</tt>.
 * 
