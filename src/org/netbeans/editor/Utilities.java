...
public class Utilities {
	...
	public static void insertMark(BaseDocument doc, Mark mark, int offset) throws BadLocationException,
			InvalidMarkException {
		doc.op.insertMark(mark, offset);
	}

	public static void moveMark(BaseDocument doc, Mark mark, int newOffset) throws BadLocationException,
			InvalidMarkException {
	...
	public static String debugDocument(Document doc) {
		return "<" + System.identityHashCode(doc) + ", title='" + doc.getProperty(Document.TitleProperty)
				+ "', stream='" + doc.getProperty(Document.StreamDescriptionProperty) + ", " + doc.toString() + ">";
	}
	 ...
	 * <tt>org.netbeans.editor.BaseKit</tt> the method returns null. The method
	...
	public static String keyStrokeToString(KeyStroke stroke) {
		...
		String keyText = (stroke.getKeyCode() == KeyEvent.VK_UNDEFINED) ? String.valueOf(stroke.getKeyChar())
