...
public class BaseSettingsInitializer extends Settings.AbstractInitializer {
	...
	public void updateSettingsMap(Class kitClass, Map settingsMap) {
		...
		if (kitClass == BaseKit.class) {
			...
			settingsMap
					.put(SettingsNames.CARET_ITALIC_OVERWRITE_MODE, SettingsDefaults.defaultCaretItalicOverwriteMode);
			...
			settingsMap.put(SettingsNames.ABBREV_ADD_TYPED_CHAR_ACCEPTOR,
					SettingsDefaults.defaultAbbrevAddTypedCharAcceptor);
			...
			SettingsUtil.updateListSetting(settingsMap, SettingsNames.KEY_BINDING_LIST,
					SettingsDefaults.defaultKeyBindings);

			// Base colorings
			SettingsUtil.setColoring(settingsMap, SettingsNames.DEFAULT_COLORING, SettingsDefaults.defaultColoring);

			SettingsUtil.setColoring(settingsMap, SettingsNames.LINE_NUMBER_COLORING,
					SettingsDefaults.defaultLineNumberColoring);

			SettingsUtil.setColoring(settingsMap, SettingsNames.BOOKMARK_COLORING,
					SettingsDefaults.defaultBookmarkColoring);

			SettingsUtil.setColoring(settingsMap, SettingsNames.GUARDED_COLORING,
					SettingsDefaults.defaultGuardedColoring);

			SettingsUtil.setColoring(settingsMap, SettingsNames.SELECTION_COLORING,
					SettingsDefaults.defaultSelectionColoring);

			SettingsUtil.setColoring(settingsMap, SettingsNames.HIGHLIGHT_SEARCH_COLORING,
					SettingsDefaults.defaultHighlightSearchColoring);

			SettingsUtil.setColoring(settingsMap, SettingsNames.INC_SEARCH_COLORING,
					SettingsDefaults.defaultIncSearchColoring);

			SettingsUtil.setColoring(settingsMap, SettingsNames.STATUS_BAR_COLORING,
					SettingsDefaults.defaultStatusBarColoring);

			SettingsUtil.setColoring(settingsMap, SettingsNames.STATUS_BAR_BOLD_COLORING,
			...
			SettingsUtil.updateListSetting(settingsMap, SettingsNames.COLORING_NAME_LIST,
					SettingsDefaults.defaultColoringNames);
