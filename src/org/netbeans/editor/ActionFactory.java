...
public class ActionFactory {
	...
	public static class RemoveLineBeginAction extends BaseAction {
		...
		public RemoveLineBeginAction() {
			super(BaseKit.removeLineBeginAction, MAGIC_POSITION_RESET | ABBREV_RESET | UNDO_MERGE_RESET
					| WORD_MATCH_RESET);
		}
	...
	public static class RemoveSelectionAction extends BaseAction {
		...
		public RemoveSelectionAction() {
			super(BaseKit.removeSelectionAction, MAGIC_POSITION_RESET | ABBREV_RESET | UNDO_MERGE_RESET
					| WORD_MATCH_RESET);
	...
	public static class GotoNextBookmarkAction extends BaseAction {
		...
		public GotoNextBookmarkAction(String nm, boolean select) {
			super(BaseKit.gotoNextBookmarkAction, ABBREV_RESET | MAGIC_POSITION_RESET | UNDO_MERGE_RESET
					| WORD_MATCH_RESET);
			this.select = select;
		}
		...
		public void actionPerformed(ActionEvent evt, JTextComponent target) {
			if (target != null) {
				...
				try {
					...
					if (selectStartPos >= 0) {
						int selectEndPos = doc.find(new FinderFactory.CharArrayFwdFinder(new char[] { ',', ')' }),
								selectStartPos, -1);
						if (selectEndPos >= 0) {
	...
	public static class InsertDateTimeAction extends BaseAction {
		...
		public InsertDateTimeAction() {
			super(BaseKit.insertDateTimeAction, ABBREV_RESET | MAGIC_POSITION_RESET | UNDO_MERGE_RESET
					| WORD_MATCH_RESET);
		}
		...
		public JMenuItem getPopupMenuItem(JTextComponent target) {
			...
			try {
				return ui
						.getDocument()
						.getAnnotations()
						.createMenu(Utilities.getKit(target),
