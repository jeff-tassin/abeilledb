...
public class ExtSettingsInitializer extends Settings.AbstractInitializer {
	...
	public void updateSettingsMap(Class kitClass, Map settingsMap) {
		...
		if (kitClass == ExtKit.class) {
			...
			SettingsUtil.updateListSetting(settingsMap, SettingsNames.COLORING_NAME_LIST, new String[] {
					ExtSettingsNames.HIGHLIGHT_CARET_ROW_COLORING, ExtSettingsNames.HIGHLIGHT_MATCH_BRACE_COLORING, });
			...
			String[] popupMenuActionNames = new String[] { BaseKit.cutAction, BaseKit.copyAction, BaseKit.pasteAction,
					null, BaseKit.removeSelectionAction };

			SettingsUtil.updateListSetting(settingsMap, ExtSettingsNames.POPUP_MENU_ACTION_NAME_LIST,
					popupMenuActionNames);

			SettingsUtil.updateListSetting(settingsMap, ExtSettingsNames.DIALOG_POPUP_MENU_ACTION_NAME_LIST,
					popupMenuActionNames);
			...
			settingsMap
					.put(ExtSettingsNames.COMPLETION_PANE_MIN_SIZE, ExtSettingsDefaults.defaultCompletionPaneMinSize);

			settingsMap
					.put(ExtSettingsNames.COMPLETION_PANE_MAX_SIZE, ExtSettingsDefaults.defaultCompletionPaneMaxSize);
