...
/**
 * Code copmletion view component interface. It best fits the <tt>JList</tt> but
 * some users may require something else e.g. JTable for displaying the result
 * of the completion query.
 * 
