...
public class Completion implements PropertyChangeListener, SettingsChangeListener, ActionListener {
	...
	public void settingsChange(SettingsChangeEvent evt) {
		...
		if (kitClass != null) {
			autoPopup = SettingsUtil.getBoolean(kitClass, ExtSettingsNames.COMPLETION_AUTO_POPUP,
			...
			refreshDelay = SettingsUtil.getInteger(kitClass, ExtSettingsNames.COMPLETION_REFRESH_DELAY,
	 ...
	 *            The <tt>ExtSettingsNames.COMPLETION_REFRESH_DELAY</tt> setting
	 *            stores the number of milliseconds before the view is
	 *            refreshed.
	 */
	...
	public synchronized void actionPerformed(ActionEvent evt) {
		...
		if (component != null && doc != null) {
			...
			try {
				...
				if ((caretPos != -1)
						&& (Utilities.getRowStart(component, component.getCaret().getDot()) != Utilities.getRowStart(
								component, caretPos))) {
