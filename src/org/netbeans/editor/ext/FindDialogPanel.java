...
public class FindDialogPanel extends javax.swing.JPanel {
	...
	public FindDialogPanel() {
		...
		findWhat.getAccessibleContext().setAccessibleDescription(
				LocaleSupport.getString("ACSD_" + SettingsNames.FIND_WHAT)); // NOI18N
		replaceWith.getAccessibleContext().setAccessibleDescription(
				LocaleSupport.getString("ACSD_" + SettingsNames.FIND_REPLACE_WITH)); // NOI18N
	}
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		replaceWithLabel
				.setDisplayedMnemonic(LocaleSupport.getChar(SettingsNames.FIND_REPLACE_WITH + "-mnemonic", 'l'));
		gridBagConstraints1 = new java.awt.GridBagConstraints();
		gridBagConstraints1.gridx = 0;
